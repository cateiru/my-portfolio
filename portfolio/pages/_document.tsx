    ...
    return (
      <Html lang="ja">
        <Head>
          ...
          <link href="https://fonts.googleapis.com/css2?family=M+PLUS+1p:wght@100;300;500&family=Noto+Sans+JP:wght@100;300;400;500;700&family=Open+Sans+Condensed:wght@300&display=swap" rel="stylesheet" />
        </Head>
        <body>
          <Main />
          <NextScript />
